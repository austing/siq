...
<div id="comments" class="comments-area<?php if ( $photostory_options_db['photostory_next_preview_post'] == 'Display' || $photostory_options_db['photostory_next_preview_post'] == '' ) { ?> comments-area-post<?php } ?>">
